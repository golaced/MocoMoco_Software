...
Publish Ver1.3.5（稳定版本）|(1)增加巡线SDK  <br>(2)增加无刷电机通讯控制接口 |	(1)修复BUG <br> (2)增加12Dof腿正逆解预留接口
...
**Publish Ver1.4(有Bug 可参考代码)**|(1)引入完整的VMC控制框架 <br> (2)增加机体姿态角度规划<br> (3)使用PD控制完成刚体控制 <br> (4)修正机器人动力学状态估计算法<br>   |(1)修复BUG<br>   
...
Ver1.4.1:  提取码： 0xz9    链接：https://pan.baidu.com/s/1NKTgxhrYMYADFr4J_UNHdQ <br>
<br>
Keil5环境软件下载：<br>
